...
plugins=(git brew node npm bower z autojump autopep8 cask catimg docker-compose docker golang httpie jsontools npm python)
...
alias v="vagrant"
alias shmn="ssh mininet@127.0.0.1 -p 4444"
